...
namespace Dynsharp
{
    class ReturnIp
    {
         ...
         */
        public static List<string> RelevantIp(List<string> ipList)
        {
            /*
            ...
            while (ipList.Count != 0)
            {
                 ...
                 */
                if (rxNewBlock.IsMatch(ipList[0]) && temp.Count == 0)
                {
                    temp.Add(ipList[0]);
                    ipList.RemoveAt(0);
                }
                 ...
                 */
                else if ((rxNewBlock.IsMatch(ipList[0]) && temp.Count > 0) || ipList.Count == 1)
                {
                    string tempString = "";
                 ...
                 */
                else if (rxContBlock.IsMatch(ipList[0]))
                {
                    temp.Add(ipList[0]);
                    ipList.RemoveAt(0);
                }
